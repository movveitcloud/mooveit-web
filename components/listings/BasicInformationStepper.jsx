...
const BasicInformationStepper = () => {
  ...
  const { address, storageType, storageFloor, storageFeatures, packing, delivery } = formDetails;
  ...
  const payload = { address, storageType, storageFloor, storageFeatures, services, packing, delivery };
