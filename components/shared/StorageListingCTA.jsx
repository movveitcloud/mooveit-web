...
const StorageListingCTA = () => {
  return (
    <div className="md:flex items-center gap-12 bg-white p-8  rounded-2xl max-w-[90%] lg:max-w-[85%] mx-auto">
      <h2 className="font-semibold text-3xl text-[#222222] mb-6  md:hidden">Try Out Storage Listing</h2>
      <div className=" w-[85%] md:w-[500px] h-[350px]">
      ...
      <div>
        ...
        <p className="text-base my-6 w-[85%] md:w-full text-[#959595]">
